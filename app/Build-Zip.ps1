...
foreach ($f in 'Setup-Bootstrap.ps1', 'Setup-Web.ps1', 'Setup-Wizard.ps1', 'Watch-Stock.ps1', 'Install-Task.ps1', 'Uninstall-Task.ps1', 'Uninstall-Quiet.ps1', 'run-hidden.vbs') {
